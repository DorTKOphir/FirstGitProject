		...
		for (int i = 0; i < this.arr.size(); i++) {
			for (int j = 0; j < this.arr.size(); j++) {
				if(this.resemble(this.arr.get(i),this.arr.get(i) )){
					System.out.println("Name : "+this.arr.get(i).getName());
					System.out.println("Number of legs : "+this.arr.get(i).getNumOfLegs());
					System.out.println("Is vegetrian : "+this.arr.get(i).isVegetrian);
